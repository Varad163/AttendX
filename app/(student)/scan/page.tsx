...
export default function StudentScanPage() {
  ...
  async function handleScan(parsed: any) {
    ...
    if (data.success) alert("Attendance Marked!");
  ...
  return (
    <div className="p-6 flex flex-col items-center justify-center">
      ...
      <div id="reader" className="w-[260px] h-[260px] border rounded-lg shadow-lg"></div>

      <p className="text-sm text-gray-600 mt-4">Align the QR inside the box</p>
    </div>
  );
}
